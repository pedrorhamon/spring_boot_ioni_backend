package com.startrek.servicesmc.services.validation;
...
import com.startrek.servicesmc.resources.exceptions.FieldMessage;
import com.startrek.servicesmc.services.validation.utils.BR;
...
public class ClienteInsertValidator implements ConstraintValidator<ClienteInsert, ClienteNewDTO> {
	...
	public boolean isValid(ClienteNewDTO objDto, ConstraintValidatorContext context) {
		...
		Cliente aux = repp.findByEmail(objDto.getEmail());
		if(aux != null) {
